  ...
  Future <List<Event>> getEvents() async {
    ...
    if (response.statusCode == 200) {
      ...
      for(var e in response.data['events']){
          ...
          Event newEvent = Event(id: e['event']['id'], titre: e['event']['titre'],description: e['event']['description'] , lieu: e['event']['lieu'], idCreateur: e['event']['idCreateur'], date: e['event']['dateEvent'], createdAt: e['event']['created_at']); 
